            ...
            <div class="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24 w-full">
                ...
                <div class="w-full lg:w-1/2 text-center lg:text-left order-2 lg:order-1">
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up"
                        ...
                        <a href="mailto:soporte@connect.com"
                            class="inline-flex items-center justify-center gap-2 glass-card text-slate-700 font-bold px-8 py-4 rounded-2xl transition-all duration-300 hover:border-brand-300 hover:text-brand-700 hover:-translate-y-1 hover:shadow-lg hover:bg-white/90 w-full sm:w-auto">
