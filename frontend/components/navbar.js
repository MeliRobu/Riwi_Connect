...
<aside id="sidebar"
  ...
  <div id="sidebar-inner" class="px-6 pt-8 pb-4 flex flex-col flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar transition-all duration-500">
    ...
    <div class="mb-10 flex items-center justify-center">
      <a href="#${isAdmin ? '/admin_home' : '/dashboard'}" data-route="${isAdmin ? '/admin_home' : '/dashboard'}" onclick="navigate(event, '${isAdmin ? '/admin_home' : '/dashboard'}')" class="flex items-center group animate-logo-in relative">
